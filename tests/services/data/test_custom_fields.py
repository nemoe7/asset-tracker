...
def test_create_custom_field_copyable(gen_test_data_admin):
  ...
  field_id = create_custom_field(name="Test Copyable", field_type="text", copyable=True)
...
def test_update_custom_field_copyable(gen_test_data_admin):
  ...
  field_id = create_custom_field(name="Test Copyable Update", field_type="text")
...
def test_get_custom_field_copyable(gen_test_data_admin):
  ...
  field_id = create_custom_field(
    name="Test Copyable Get", field_type="text", copyable=True
  )
